...
This is an example that shows steps of using the cross test `abYlm.Mglm` to test for the null hypothesis of no mediation effect under the linear structural equation models.
